    ...
    public void run() {
        try {
            ...
            if (con.getResponseCode() == 200) {
                ...
                prefEditor.apply();
                Toast.makeText(this.appContext, "login successful.", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(this.appContext, MainActivity.class); //TODO: replace this with whatever activity you want it to go to.
                this.returnCode=200;

            } else if (con.getResponseCode() == 400) {
                Toast.makeText(this.appContext, "Invalid login.", Toast.LENGTH_LONG).show();
                this.returnCode=400;
            } else {
                this.returnCode=401;
                Toast.makeText(this.appContext, "An error occurred. Please try again.", Toast.LENGTH_LONG).show();
            }
